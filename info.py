...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002076051187').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Ajay:Ajay@cluster0.isdhuzs.mongodb.net/?retryWrites=true&w=majority")
...
REQ_CHANNEL = environ.get("REQ_CHANNEL", '-1001839998122')
